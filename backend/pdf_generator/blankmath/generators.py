...
from blankmath.worksheets.fractions import add_fraction, compare_fraction, equivalent_fraction, multiply_divide_fraction, reduce_fraction
...
def _generator_for(worksheet_type: str):
    return {
        ...
        "fraction_multiplication_division": multiply_divide_fraction,
